...
if __name__ == '__main__':    
    ...
    strMyEmailAddress = "myemail@google.com"   # The google account you typically use for GoogleSheet work goes here (doesn't have to be the same account you registered)
    ...
    for i in range(30):    # read 30 observations, or you could use while True: and just let the sensor read forever and ever ...
